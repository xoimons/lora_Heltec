...
// ============================================
// - Arranca bomba: IN1=0 I boiaBomba=1 I SOC>=30% (si disponible)
// - Para bomba:    IN1=1 O boiaBomba=0 O SOC<=20% O (switchMitja=1 I IN2LoRa=1) O potenciometre O timeout
...
// ============================================
// Sortides 2, 3, 4: repliquen IN2, IN3, IN4
